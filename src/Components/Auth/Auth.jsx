                ...
                }
            {
                ...
                <div className={this.state.error ?
                    ...
                    <div className='buttona'>
                        ...
                        <button className="register" onClick={this.changeDisplay}>Register</button>
                    </div>
                </div>
                :
                <div className="login-register-container">
                    ...
                    <div className='buttons'>
                        <button className="login" onClick={this.register}>Sign Up</button>
                        <button className="register" onClick={this.changeDisplay}>Cancel</button>
                    </div>
                </div>
            }
                </div>
